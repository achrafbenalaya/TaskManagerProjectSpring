<%@page import="tn.iit.task.controllers.UserController"%>
...
<body class="hold-transition lockscreen">
	...
	<div class="lockscreen-wrapper">
		...
		%>
		<!-- User name -->
		<div class="lockscreen-name"><%out.print(name.toString());%></div>
		...
		<div class="lockscreen-footer text-center">
			Copyright &copy; 2017-2018 <b><a href="#"
				class="text-black">TaskIdo</a></b><br> All rights reserved
		</div>
	</div>
	<!-- /.center -->
