...
<title>TaskIdo | Registration Page</title>
...
<body class="hold-transition register-page">
	<div class="register-box">
		<div class="register-logo">
			<a href="./Indexo.jsp"><b>Task</b>Ido</a>
		</div>

		<div class="register-box-body">
			<p class="login-box-msg">Register a new membership</p>

			<form action="user/reg" method="post" data-toggle="validator">
				...
				<div class="form-group has-feedback">
					<input type="text" class="form-control" required="true"
						placeholder="last name" name="lastname"> <span
						class="glyphicon glyphicon-user form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback">
					<input type="text" class="form-control" required="true"
						placeholder="pseudo" name="login"> <span
						class="glyphicon glyphicon-user form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback">
				...
				<div class="form-group">
					<div class="form-group has-feedback">
						...
						<input type="password" data-minlength="6" class="form-control"
							required="true" placeholder="Password" id="inputPassword"
							name="password"> <span
							class="glyphicon glyphicon-lock form-control-feedback"></span>
					</div>
					<div class="form-group has-feedback">
						<input type="password" class="form-control" required="true"
							placeholder="Retype password" data-match="#inputPassword"
							data-match-error="Whoops, these don't match"
							id="inputPasswordConfirm" name="passwordd"> <span
					...
					<div class="col-xs-8">
						<div class="checkbox icheck">
							<label> <input type="checkbox"
								data-error="you must agree to the terms" id="terms"
								required="true"> I agree to the <a href="#">terms</a>
							</label>
						</div>
					</div>
					<!-- /.col -->
