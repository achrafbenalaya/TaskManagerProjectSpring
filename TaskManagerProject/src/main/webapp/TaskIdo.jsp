	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="row">
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-aqua">
						<div class="inner">
							<h3>
								<a href="admin/project/list" />Project
							</h3>
						...
						<a href="./resources/pages/forms/AddnewProject.html"
							class="small-box-footer"><a href="admin/project/show" />Create
				...
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-green">
						<div class="inner">
							<h3>
								<a href="admin/team/list" /> Team<sup style="font-size: 20px"></sup>
							</h3>
						...
						<a href="#" class="small-box-footer"><a href="admin/team/show" />Create<i
				...
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-yellow">
						<div class="inner">
							<h3>
								<a href="admin/organisation/list" />Organisation
							</h3>
						...
						<a href="#" class="small-box-footer"><a
							href="admin/organisation/show" />Create <i
							class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-red">
						...
						<a href="#" class="small-box-footer"><a href="admin/task/show" />Create
							<i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<!-- ./col -->
			...
			<div class="row">
				...
				<!-- /.nav-tabs-custom --> <!-- Chat box --> <!-- /.box (chat box) -->
				...
				<!-- /.box --> <!-- solid sales graph --> <!-- /.box --> <!-- Calendar -->
