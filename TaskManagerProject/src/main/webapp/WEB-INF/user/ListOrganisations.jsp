...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				List Organisation <small>Control panel</small>
			</h1>
			<ol class="breadcrumb">
			...
			<div class="input-group-btn">
				<a href="show" type="button"
					class="btn btn-block bg-purple margin btn-lg">New Organisation</a>
					...
					<div class="box">
						<form action="rech" method="get">
							<div class="box-header">
								<h3 class="box-title">List of All organisation</h3>
								<div class="box-tools">
						...
						<div class="box-body table-responsive padding='10'">
							<table class="table table-hover">
								...
								<%
									List<Organisation> orgsRech = new ArrayList<Organisation>();
									System.out.println(session.getAttribute("organisationsRech"));
									orgsRech = (ArrayList<Organisation>) session.getAttribute("organisationsRech");
									if (orgsRech == null) {
								%>
								...
								<c:forEach items="${OrganisationArray}" var="organisation">
									<tr>
										...
										<td><fmt:formatDate value="${organisation.datecreation}"
										...
										<td>
											...
											<div class="modal modal-danger fade"
												id="modal-danger<c:out value="${organisation.id}"/>"
												style="display: none;">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<h2>
																<c:out value="${organisation.name}"></c:out>
																!
															</h2>
															</p>
														</div>
											...
											<button type="button" class="btn btn-danger"
												data-toggle="modal"
												data-target="#modal-danger<c:out value="${organisation.id}"/>">
												Delete organisation</button> <!-- end Modal Block -->
								...
								%>
								<c:forEach items="${organisationsRech}" var="organisation">
									<tr>
										<td><c:out value="${organisation.name}"></c:out></td>
										<%-- <td><c:out value="${organisation.datecreation}"></c:out></td> --%>
										<td><fmt:formatDate value="${organisation.datecreation}"
