...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
						...
						<li>
							...
							<ul class="menu">
								...
								<li><a href="#">
										...
										<h4>
											TaskIDO Team <small><i class="fa fa-clock-o"></i> 2
												hours</small>
										</h4>
										<p>Why not buy a new awesome theme?</p>
								</a></li>
		...
		<div class="content-wrapper">
			...
			<h1>
				List projects <small>Control panel</small>
			</h1>
			<ol class="breadcrumb">
			...
			<div class="input-group-btn">
				<a href="show" type="button"
					class="btn btn-block bg-purple margin btn-lg">New Project</a>
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
						...
						<div class="box-body table-responsive padding='10'">
							<table class="table table-hover">
								...
								<%
									List<Project> projectRech = new ArrayList<Project>();
									projectRech = (ArrayList<Project>) session.getAttribute("projectsRech");
									if (projectRech == null) {
								%>
								...
								<c:forEach items="${projectArray}" var="project">
									<tr>
										...
										<td><fmt:formatDate value="${project.dateDebut}"
												pattern="yyyy-MM-dd" /></td>
										<td><fmt:formatDate value="${project.dateFin}"
												pattern="yyyy-MM-dd" /></td>
										...
										<%-- 											</c:url> <c:url value="delete" var="dell"> --%>
										...
										<td><c:url value="delete" var="dell">
												<c:param name="action" value="delete" />
												<c:param name="id" value="${project.id}" />
											</c:url> <c:url value="updateform" var="edit">
												<c:param name="action" value="edit" />
												<c:param name="id" value="${project.id}" />
											</c:url> <%-- <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href='<c:out value="${edit}"/>'>Edit</a></li>

                     <li class="divider"></li>
                    <li><a href='<c:out value="${dell}"/>'>Delete</a></li>
                  </ul>
                </div> --%>
										...
										<td>
											...
											<div class="modal modal-danger fade"
												id="modal-danger<c:out value="${project.id}"/>"
												style="display: none;">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															...
															<h4 class="modal-title" value="${project.nameProject}">Delete
																project</h4>
														...
														<div class="modal-body">
															...
															<h2>
																<c:out value="${project.nameProject}"></c:out>
																!
															</h2>
															</p>
														</div>
											...
											<button type="button" class="btn btn-danger"
												data-toggle="modal"
												data-target="#modal-danger<c:out value="${project.id}"/>">
												Delete Project</button> <!-- end Modal Block -->
								...
								<!-- reultat de recherche -->
								<%
									} else {
								%>
								<c:forEach items="${projectsRech}" var="project">
									<tr>
										<td><c:out value="${project.nameProject}"></c:out></td>
										<td><fmt:formatDate value="${project.dateDebut}"
												pattern="yyyy-MM-dd" /></td>
