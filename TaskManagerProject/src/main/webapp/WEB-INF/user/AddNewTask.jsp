		...
		<div class="content-wrapper">
			...
			<div class="box box-warning">
				<div class="box-header with-border">
					<h3 class="box-title">Insert new Task</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<form role="form" action="addTask" method="post"
						...
						<div class="form-group">
							<label>Name Task</label> <input class="form-control" type="text"
								required="true" name="nametask" placeholder="Enter ...">
						</div>

						<div class="form-group">
							<label>progress</label> <input class="form-control" type="text"
								required="true" name="progress" placeholder="Enter ...">
						</div>

						<div class="form-group">
							<label>comments</label> <input class="form-control" type="text"
								required="true" name="comments" placeholder="Enter ...">
						</div>
