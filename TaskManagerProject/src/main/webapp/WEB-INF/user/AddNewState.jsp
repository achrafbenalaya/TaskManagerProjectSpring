		...
		<div class="content-wrapper">
			...
			<div class="box box-warning">
				<div class="box-header with-border">
					<h3 class="box-title">Insert new State</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					...
					<form role="form" action="add" method="post"
						...
						<div class="form-group">
							<label>Name State</label> <input class="form-control" type="text"
								required="true" name="namestate" placeholder="Enter ...">
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input class="form-control pull-right" type="date"
									name="datecreation" id="datepicker">
							</div>
							<!-- /.input group -->
						</div>
							...
							<label>projects</label> <select
								...
								<c:forEach items="${ProjectsArray}" var="item">
									<option value="<c:out value="${item.id}"/>">
										<c:out value="${item.nameProject}" /></option>
