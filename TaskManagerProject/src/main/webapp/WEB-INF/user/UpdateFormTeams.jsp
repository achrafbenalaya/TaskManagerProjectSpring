				...
				<div class="box-body">
					<form role="form" action="edit" method="post"
						...
						<div class="form-group">
							<label>Name User</label> <input type="text" name="name"
						...
						<div class="form-group">
							<label>Type</label> <select
								...
								name="typeTeam" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
								...
								<c:choose>
									<c:when test="${oneTeam.typeTeam == 'free'}">
										<option value="free" selected="selected">free</option>
										<option value="preminum">preminum</option>
										<option value="company">company</option>
									</c:when>
									<c:when test="${oneTeam.typeTeam == 'company'}">
										<option value="free">free</option>
										<option value="preminum">preminum</option>
						...
						<div class="form-group">
							<label>organization</label> <select
								class="form-control select2 select2-hidden-accessible"
								name="organization" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
						...
						<div class="form-group">
							<label>Project</label> <select
								class="form-control select2 select2-hidden-accessible"
								name="project" type="text" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
								<option value="">aucun project</option>
								<c:forEach items="${ProjectArray}" var="item">
									<option value="<c:out value="${item.id}"/>"><c:out
