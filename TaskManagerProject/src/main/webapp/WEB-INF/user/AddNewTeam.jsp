		...
		<div class="content-wrapper">
			...
			<div class="box box-warning">
				<div class="box-header with-border">
					<h3 class="box-title">Insert new Team</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					...
					<form role="form" action="add" method="post"
						...
						<div class="form-group">
							<label>Name</label> <input class="form-control" type="text"
								required="true" name="name" placeholder="Enter ...">
						</div>
						...
						<div class="form-group">
							<label>Type</label> <select
								...
								name="typeTeam" type="text" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
						...
						<div class="form-group">
							<label>organization</label> <select
								class="form-control select2 select2-hidden-accessible"
								name="organization" type="text" style="width: 100%;"
