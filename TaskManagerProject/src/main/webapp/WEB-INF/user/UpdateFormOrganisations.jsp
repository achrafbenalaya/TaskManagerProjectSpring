		...
		<div class="content-wrapper">
			...
			<div class="box box-warning">
				<div class="box-header with-border">
					<h3 class="box-title">Update Organisation :</h3>
					<%
				...
				<div class="box-body">
					<form role="form" action="edit" method="post"
						...
						<div class="form-group">
							<label>Organisation Name </label> <input type="text" name="name"
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<%-- <input type="text" class="form-control pull-right"
									name="datecreation" value="<%=Organisation.getDatecreation()%>"
									id="datepicker"> --%>
								<input type="date" class="form-control pull-right"
									name="datecreation"
									value='<fmt:formatDate value="${oneOrganisation.datecreation}" pattern="yyyy-MM-dd"/>'
									id="datepicker">
								<%-- value='<fmt:formatDate value="${oneOrganisation.datecreation}" pattern="yyyy-MM-dd"/>' --%>
							</div>
							<!-- /.input group -->
						...
						<div class="form-group">
							<label>Type</label> <select
								...
								<c:choose>
									<c:when test="${oneOrganisation.type == 'free'}">
