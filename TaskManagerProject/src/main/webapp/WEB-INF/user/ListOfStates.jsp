...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				List States <small>Control panel</small>
			</h1>
			<ol class="breadcrumb">
			...
			<div class="input-group-btn">
				<a href="show" type="button"
					class="btn btn-block bg-purple margin btn-lg">New State</a>
					...
					<div class="box">
						...
						<div class="box-body table-responsive padding='10'">
							<table class="table table-hover">
								...
								<%
									List<State> statesRech = new ArrayList<State>();
									statesRech = (ArrayList<State>) session.getAttribute("statesRech");
									if (statesRech == null) {
								%>
								...
								<c:forEach items="${StateArray}" var="state">
									<tr>
										...
										<td><c:out value="${state.project.nameProject}"></c:out>
										<td><c:out value="${state.project.type}"></c:out></td>
										...
										<td>
											...
											<div class="modal modal-danger fade"
												id="modal-danger<c:out value="${state.id}"/>"
												style="display: none;">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<h2>
																<c:out value="${state.namestate}"></c:out>
																!
															</h2>
															</p>
														</div>
											...
											<button type="button" class="btn btn-danger"
												data-toggle="modal"
												data-target="#modal-danger<c:out value="${state.id}"/>">
								...
								%>
								<c:forEach items="${statesRech}" var="state">
									<tr>
										<td><c:out value="${state.namestate}"></c:out></td>
										<td><c:out value="${state.datecreation}"></c:out></td>
										<td><c:out value="${state.project.nameProject}"></c:out>
