				...
				<div class="box-body">
					<form role="form" action="edit" method="post"
						...
						<div class="form-group">
							<label>Name Project</label> <input type="text" name="nameProject"
								required="true" class="form-control" placeholder="Enter ..."
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input type="Date" class="form-control pull-right"
									name="dateDebut"
									value='<fmt:formatDate value="${oneProject.dateDebut}" pattern="yyyy-MM-dd"/>'
									id="datepicker">
							</div>
							<!-- /.input group -->
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input type="Date" class="form-control pull-right"
									id="datepicker1" name="dateFin"
									value='<fmt:formatDate value="${oneProject.dateFin}" pattern="yyyy-MM-dd"/>'>
							</div>
							<!-- /.input group -->
						</div>
						<!-- /.box-body -->
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" type="text"
								name="description"<%-- value="<%=project.getDescription()%>" --%> ><%=project.getDescription()%></textarea>
						</div>
