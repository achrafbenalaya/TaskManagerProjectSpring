				...
				<div class="box-body">
					<form role="form" action="edit" method="post"
						...
						<div class="form-group">
							<label>Name User</label> <input type="text" name="firstname"
						...
						<div class="form-group">
							<label for="exampleInputPassword1">Password</label> <input
								class="form-control" type="text" name="password" required="true"
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Email address</label> <input
								...
								required="true" data-error="Bruh, that email address is invalid"
						...
						<div class="form-group">
							<label>Type</label> <select
								...
								name="typeuser" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
