				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header"><img
							...
							<p>
								<c:out value="${loginUserAuthentified}"/> <small>Member since @Date</small>
							</p></li>
						<!-- Menu Body -->
						<li class="user-body">
							<div class="row">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
				...
				<ul class="treeview-menu">
					...
					<li><a href="../../admin/project/list"><i
							...
							<li><a href="../../admin/state/list"><i class="fa fa-circle-o"></i>My
							States</a></li>
							<li><a href="../../admin/user/list"><i class="fa fa-circle-o"></i>My
							Users</a></li>
					<li><a href="#"><i
							class="fa fa-circle-o"></i> Progress</a></li>
					<li><a href="#"><i
							class="fa fa-circle-o"></i> Notifications</a></li>

					<li><a href="../../ContactUs.jsp"><i class="fa fa-circle-o"></i>
							Contact</a></li>
				</ul></li>
		...
		<div class="content-wrapper">
			...
			<div class="input-group-btn">
				<a href="show" type="button"
					class="btn btn-block bg-purple margin btn-lg">New Team</a>
					...
					<div class="box">
						<form action="rech" method="get">
							<div class="box-header">
								<h3 class="box-title">List of All Team</h3>
								<div class="box-tools">
						...
						<div class="box-body table-responsive padding='10'">
							<table class="table table-hover">
								...
								<%
									List<Team> teamsRech = new ArrayList<Team>();
									teamsRech = (ArrayList<Team>) session.getAttribute("teamsRech");
									if (teamsRech == null) {
								%>
								...
								<c:forEach items="${teamArray}" var="team">
									<tr>
										<td>
											<c:out value="${team.project.nameProject}"></c:out>
											<c:if test="${empty team.project.nameProject}">aucun project</c:if>
										</td>
										<td><c:out value="${team.name}"></c:out></td>
										<td><c:out value="${team.typeTeam}"></c:out></td>
										<td>
											<c:out value="${team.organisation.name}"></c:out>
											<c:if test="${empty team.organisation.name}">aucune organisation</c:if>
										</td>
										...
										<td>
											...
											<div class="modal modal-danger fade"
												id="modal-danger<c:out value="${team.id}"/>"
												style="display: none;">
											...
											<button type="button" class="btn btn-danger"
												data-toggle="modal"
												data-target="#modal-danger<c:out value="${team.id}"/>">
												Delete Teams</button> <!-- end Modal Block -->
										</td>
									</tr>
								</c:forEach>
								<!-- resultat de recherche -->
								<%}else{%>
								<c:forEach items="${teamsRech}" var="team">
									<tr>
										<td>
											<c:out value="${team.project.nameProject}"></c:out>
											<c:if test="${empty team.project.nameProject}">aucun project</c:if>
