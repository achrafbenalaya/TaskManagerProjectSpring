				...
				<div class="box-body">
					<form role="form" action="edit" method="post"
						...
						<input type="hidden" name="id"
							value='<c:out value="${ oneTask.id }" />'>


						<div class="form-group">
							<label>Name Task</label> <input class="form-control" type="text"
								required="true" name="nametask"
								value='<c:out value="${ oneTask.nametask}" />'
								placeholder="Enter ...">
						</div>

						<div class="form-group">
							<label>progress</label> <input class="form-control" type="text"
								required="true" name="progress"
								value='<c:out value="${ oneTask.progress}" />'
								placeholder="Enter ...">
						</div>

						<div class="form-group">
							<label>comments</label> <input class="form-control" type="text"
								name="comments" value='<c:out value="${ oneTask.comments}" />'
								placeholder="Enter ...">
						</div>
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" type="text"
								value='<c:out value="${ oneTask.description}" />'
								name="description" placeholder="Enter ..."><c:out
									value="${ oneTask.description}" /></textarea>
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input class="form-control pull-right" type="date"
									value='<fmt:formatDate value="${oneTask.dateDebut}" pattern="yyyy-MM-dd"/>'
									name="dateDebut" id="datepicker">
								<%-- value='<c:out value="${ oneTask.dateDebut }" />' --%>
							</div>
							<!-- /.input group -->
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input class="form-control pull-right" type="date"
									value='<fmt:formatDate value="${oneTask.dateFin}" pattern="yyyy-MM-dd"/>'
									name="dateFin" id="datepicker1">
								<%-- value='<c:out value="${ oneTask.dateFin }" />' --%>
							</div>
							<!-- /.input group -->
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input class="form-control pull-right" type="date"
									value='<fmt:formatDate value="${oneTask.dueDate}" pattern="yyyy-MM-dd"/>'
									name="dueDate" id="datepicker1">
								<%-- value='<c:out value="${ oneTask.dueDate }" />' --%>
							</div>
							<!-- /.input group -->
						</div>
						...
						<div class="form-group">
							<label>Type</label> <select
								...
								name="priority" type="text" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
								<!--<option value="1">high priority</option>
								<option value="0">low priority</option>-->
								<c:choose>
									<c:when test="${oneTask.priority == 1}">
										<option value="1" selected="selected">high priority</option>
										<option value="0">low priority</option>
									</c:when>
									<c:otherwise>
										<option value="1">high priority</option>
										<option value="0" selected="selected">low priority</option>
									</c:otherwise>
								</c:choose>
						...
						<!--state-->
						<div class="form-group">
							<label>Sate</label> <select
								class="form-control select2 select2-hidden-accessible"
								name="state" type="text" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
								<option disabled="disabled">Chose One State</option>
								<c:forEach items="${StatenArray}" var="item">
									<option value="<c:out value="${item.id}"/>"><c:out
											value="${item.namestate}" /></option>
								</c:forEach>
							</select>
						</div>
						<!--state-->
						...
						<div class="box-footer">
							...
							<button type="submit" value="modifier" class="btn btn-primary">Submit</button>
