				...
				<div class="box-body">
					<form role="form" action="edit" method="post"
						...
						<input type="hidden" name="id"
							value='<c:out value="${ oneState.id }" />'>


						<div class="form-group">
							<label>Name Project</label> <input type="text" name="namestate"
								required="true" class="form-control" placeholder="Enter ..."
								value="<c:out value="${ oneState.namestate }" />">
						...
						<div class="form-group">
							<label>Project</label> <select
								...
								name="project" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
