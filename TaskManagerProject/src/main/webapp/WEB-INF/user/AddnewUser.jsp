		...
		<div class="content-wrapper">
			...
			<div class="box box-warning">
				<div class="box-header with-border">
					<h3 class="box-title">Insert new User</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					...
					<form role="form" action="add" method="post"
						...
						<div class="form-group">
							<label>Name User</label> <input class="form-control" type="text"
								required="true" name="firstname" placeholder="Enter ...">
						</div>

						<div class="form-group">
							<label>Last Name</label> <input class="form-control" type="text"
								required="true" name="lastname" placeholder="Enter ...">
						</div>
						<div class="form-group">
							<label>Login</label> <input class="form-control" type="text"
								required="true" name="login" placeholder="Enter ...">
						</div>
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Email address</label> <input
								...
								data-error="Bruh, that email address is invalid" type="email"
						...
						<div class="form-group">
							<label>Type</label> <select
								...
								name="typeuser" type="text" style="width: 100%;" tabindex="-1"
								aria-hidden="true">

								<option value="free">admin</option>
								<option value="ROLE_ADMIN">Super-Admin</option>
								<option disabled="disabled">DB-Admin (disabled)</option>

							</select>
						</div>

						<div class="form-group">
							<label>Teams</label> <select
								class="form-control select2 select2-hidden-accessible"
								name="team" type="text" style="width: 100%;" tabindex="-1"
								aria-hidden="true">
								<option value="">aucun team</option>
								<c:forEach items="${teamArray}" var="item">
