...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				List Of Tasks <small>Control panel</small>
			</h1>
			<ol class="breadcrumb">
			...
			<div class="input-group-btn">
				<a href="show" type="button"
					class="btn btn-block bg-purple margin btn-lg">New Task</a>
					...
					<div class="box">
						<form action="rech" method="get">
							<div class="box-header">
								<h3 class="box-title">List of All Tasks</h3>
								<div class="box-tools">
						...
						<div class="box-body table-responsive padding='10'">
							<table class="table table-hover">
								...
								<%
									List<Task> tasksRech = new ArrayList<Task>();
									tasksRech = (ArrayList<Task>) session.getAttribute("tasksRech");
									if (tasksRech == null) {
								%>
								...
								<c:forEach items="${TaskArray}" var="item">
									<tr>
										...
										<td><fmt:formatDate value="${item.dateDebut}"
												pattern="yyyy-MM-dd" /></td>
										<td><fmt:formatDate value="${item.dateFin}"
												pattern="yyyy-MM-dd" /></td>
										<%-- <td><c:out value="${item.dateFin}"></c:out></td> --%>
										<td><c:if test="${1 == item.priority}">high priority</c:if>
											<c:if test="${0 == item.priority}">low priority</c:if> <%-- <c:out value="${item.priority}"></c:out> --%>
										</td>
										<td><fmt:formatDate value="${item.dueDate}"
												pattern="yyyy-MM-dd" /></td>
										<%-- <td><c:out value="${item.dueDate}"></c:out></td> --%>
										<td><c:out value="${item.state.namestate}"></c:out></td>
										...
										<td>
											...
											<div class="modal modal-danger fade"
												id="modal-danger<c:out value="${item.id}"/>"
												style="display: none;">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<h2>
																<c:out value="${item.nametask}"></c:out>
																!
															</h2>
															</p>
														</div>
											...
											<button type="button" class="btn btn-danger"
												data-toggle="modal"
												data-target="#modal-danger<c:out value="${item.id}"/>">
								...
								%>
								<c:forEach items="${tasksRech}" var="item">
									<tr>
										<td><c:out value="${item.nametask}"></c:out></td>
										<td><c:out value="${item.progress}"></c:out></td>
										<td><c:out value="${item.comments}"></c:out></td>
